...
class SpreadsheetReader_ODS implements \Iterator, \Countable
{
    ...
    public function __construct($Filepath, array $Options = null) {
        ...
        if ($Status !== true) {
            throw new \Exception(
                    'SpreadsheetReader_ODS: File not readable (' . $Filepath . ') (Error ' . $Status . ')');
        }
    ...
    public function next() {
        ...
        if (!$this->TableOpen) {
            ...
            while ($this->Valid = ($SkipRead || $this->Content->read())) {
                ...
                if ($this->Content->name == 'table:table'
                        && $this->Content->nodeType != \XMLReader::END_ELEMENT) {
