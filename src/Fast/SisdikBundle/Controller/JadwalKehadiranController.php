...
class JadwalKehadiranController extends Controller
{
        ...
        $perulangan = 'harian')
    {
        ...
        $searchform = $this->createForm(new JadwalKehadiranSearchType(
            $this->container, 
            $perulangan));
        ...
        Request $request)
    {
        ...
        $form = $this->createForm(new JadwalKehadiranDuplicateType(
            $this->container, 
            $sekolah->getId()));
        ...
        Request $request)
    {
        ...
        $entity = new JadwalKehadiran();
        $form = $this->createForm(new JadwalKehadiranType(
            $this->container, 
            $sekolah->getId()), $entity);
        $form->submit($request);
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('jadwal_kehadiran_show', array(
                'id' => $entity->getId()
            )));
        }
        ...
        $id)
    {
        ...
        $editForm = $this->createForm(new JadwalKehadiranType(
            $this->container, 
            $sekolah->getId()), $entity);
        $deleteForm = $this->createDeleteForm($id);
        ...
        $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('jadwal_kehadiran_edit', array(
                'id' => $id
            )));
        }
        ...
        $id)
    {
        ...
        return $this->redirect($this->generateUrl('jadwal_kehadiran_list', array(
    ...
    /**
	 * API untuk mengunduh jadwal kehadiran untuk mesin wakil tertentu
	 *
	 * @Route("/_api/jadwal-kehadiran/{token}.{_format}", name="jadwal_kehadiran_unduh-jadwal", defaults={"_format"="xml"}, requirements={"_format"="(xml|json)"})
	 * @Method("GET")
	 */
    public function unduhJadwalKehadiranAction(
        $token)
    {
        $em = $this->getDoctrine()->getManager();
        ...
        if (count($entity) == 1) {
            ...
            throw new NotFoundHttpException(
                $this->get('translator')->trans('exception.token.tak.sahih'));
        }
    }
