 ...
 * @author Ihsan Faisal
 */
class FingerPrintAlterPunctualCommand extends ContainerAwareCommand
{
    protected function configure() {
        $this->setName('fp:alter:punctual')
                ->setDescription('Update students presence status to punctual')
