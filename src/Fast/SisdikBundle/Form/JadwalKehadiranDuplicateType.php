...
class JadwalKehadiranDuplicateType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('sekolahSrc', 'hidden', array(
            'data' => $this->sekolahSrc
        ))
            ->add('tahunAkademikSrc', 'hidden', array(
            'data' => $this->tahunAkademikSrc
        ))
            ->add('kelasSrc', 'hidden', array(
            'data' => $this->kelasSrc
        ))
            ->add('perulanganSrc', 'hidden', array(
            'data' => $this->perulanganSrc
        ))
            ->add('requestUri', 'hidden', array(
            'data' => $this->requestUri
        ))
            ->add('mingguanHariKeSrc', 'hidden', array(
            'data' => $this->mingguanHariKeSrc
        ))
            ->add('bulananHariKeSrc', 'hidden', array(
        ...
        $builder->add('perulangan', 'choice', array(
            ...
            ->add('mingguanHariKe', 'choice', array(
            ...
            ->add('bulananHariKe', 'choice', array(
