...
class BiayaRutinType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('perulangan', 'choice',
                        array(
                                'choices' => $this->buildRecurringChoices(), 'required' => true,
    ...
    public function buildRecurringChoices() {
        return array(
                'hari' => 'label.daily', 'minggu' => 'label.weekly', 'bulan' => 'label.monthly',
                'tahun' => 'label.annually'
        );
    }

    public function getName() {
        return 'fast_sisdikbundle_biayarutintype';
    }
}
