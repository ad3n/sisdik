...
class JadwalKehadiranType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('statusKehadiran', 'choice', array(
            ...
            ->add('paramstatusDariJam', 'time', array(
            ...
            ->add('paramstatusHinggaJam', 'time', array(
        ...
        $builder->add('templatesms', 'entity', array(
        ...
        $builder->add('otomatisTerhubungMesin', 'checkbox', array(
