...
class CalonTransaksiPembayaranSekaliType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver
                ->setDefaults(
                        array(
                            'data_class' => 'Fast\SisdikBundle\Entity\CalonTransaksiPembayaranSekali'
                        ));
    }

    public function getName() {
        return 'fast_sisdikbundle_calontransaksipembayaransekalitype';
    }
}
