 ...
 * @FormType
 */
class JadwalKepulanganType extends AbstractType
{
    /**
     * @var SecurityContext
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('otomatisTerhubungMesin', 'checkbox', [
                'label' => 'label.otomatis.terhubung.mesin.kepulangan',
                'required' => false,
                'label_render' => true,
                'widget_checkbox_label' => 'widget',
                'horizontal_input_wrapper_class' => 'col-sm-offset-4 col-sm-8 col-md-offset-4 col-md-7 col-lg-offset-3 col-lg-9',
            ...
            ->add('permulaan', 'checkbox', [
                'label' => 'label.awal.kepulangan',
                'required' => false,
                'help_block' => 'help.awal.kepulangan',
                'label_render' => true,
                'widget_checkbox_label' => 'widget',
                'horizontal_input_wrapper_class' => 'col-sm-offset-4 col-sm-8 col-md-offset-4 col-md-7 col-lg-offset-3 col-lg-9',
            ])
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver
            ->setDefaults([
                'data_class' => 'Langgas\SisdikBundle\Entity\JadwalKepulangan',
            ])
        ;
    }
    ...
    {
        return 'sisdik_jadwalkepulangan';
    }
}
