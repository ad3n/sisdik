...
/**
 * @ORM\Table(name="proses_log_kepulangan")
 * @ORM\Entity
 */
class ProsesLogKepulangan
{
    /**
    ...
    /**
     * Daftar status antrian kepulangan yang dapat digunakan.
     *
     * @return array
     */
    ...
    {
        return [
            'a-masuk-antrian' => 'proses.log.pulang.antri',
            'b-sedang-dikerjakan' => 'proses.log.pulang.dikerjakan',
            'c-selesai' => 'proses.log.pulang.selesai',
        ];
    }
}
